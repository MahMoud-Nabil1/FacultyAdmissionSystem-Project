...
export const CUSTOMIZABLE_TOKENS = [
    { key: "primary", labelAr: "اللون الأساسي", labelEn: "Primary", type: "color", default: "var(--color-primary)" },
    { key: "primary-hover", labelAr: "اللون الأساسي (تمرير)", labelEn: "Primary hover", type: "color", default: "var(--color-primary-hover)" },
    ...
    { key: "success", labelAr: "النجاح", labelEn: "Success", type: "color", default: "var(--color-success)" },
    { key: "error", labelAr: "الخطأ", labelEn: "Error", type: "color", default: "var(--color-error)" },
    { key: "warning", labelAr: "تحذير", labelEn: "Warning", type: "color", default: "var(--color-warning)" },
    { key: "bg-light", labelAr: "خلفية فاتحة", labelEn: "Background light", type: "color", default: "var(--color-bg)" },
    ...
    { key: "text-muted", labelAr: "النص الثانوي", labelEn: "Text muted", type: "color", default: "var(--color-text-muted)" },
    { key: "border", labelAr: "الحدود", labelEn: "Border", type: "color", default: "var(--color-border)" },
