...
const AnnouncementsPage: React.FC = () => {
    ...
    return (
        <div className="dashboard-container">
            <h2 style={{ textAlign: "center", marginBottom: "20px" }}>{t("announcementsAdminPanel.title")}</h2>

            <button className="panel-btn" style={{ width: "100%", marginBottom: "12px" }} onClick={() => setShowForm(prev => !prev)}>
                {showForm
            ...
            {showForm && (
                <form className="form" onSubmit={handleSubmit} style={{ marginBottom: "20px" }}>
                    ...
                    <div className="form-group">
                        <label>{t("dashboardCommon.title")}</label>
                        <input
                    ...
                    <div className="form-group">
                        <label>{t("dashboardCommon.content")}</label>
                        <textarea
                    ...
                    <div style={{ display: "flex", gap: "10px" }}>
                        <button className="panel-btn" disabled={loading} style={{ flex: 1 }}>
                            {loading
                        ...
                        {editingId && (
                            <button type="button" className="cancel-btn" onClick={handleCancel} style={{ flex: 1 }}>
